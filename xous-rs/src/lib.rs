...
pub type SyscallResult = XousResult;
...
extern "Rust" {
    ...
    fn _xous_syscall(nr: u32, a1: u32, a2: u32, a3: u32, a4: u32, a5: u32, a6: u32, a7: u32, ret: &mut SyscallResult);
}
...
pub fn syscall(args: SyscallArguments) -> SyscallResult {
    ...
    // let mut ret = [0; 8];
    let mut ret = XousResult::XousError(42);
